...
if (isset($_POST['create_post'])) {
    ...
    $published = 1; // ou 0 si tu veux forcer la non publication par défaut
...
<body>
	...
	<div class="container content">
		...
		<div class="action create-post-div">
			...
			<form method="post" enctype="multipart/form-data" action="<?php echo BASE_URL . 'weblog_v0/admin/create_post.php'; ?>" >
